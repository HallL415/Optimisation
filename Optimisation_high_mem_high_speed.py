...
################################################# new addition
 ...
 ##########################################################################################################################       
        ...
        for j in range(len(V_indices)):
            ...
            i_values[f'{V_indices[j]}'] = [permutations[i][int(i_pos[j])] for i in range(n)]
            i_values_U[f'{U_indices[j]}'] = [permutations[i][int(i_pos_U[j])] for i in range(n)]
        ...
        #     for j in range(len(V_indices)):                        
        #         i_values[f'{V_indices[j]}'].append(permutations[i][int(i_pos[j])])
                
        #         i_values_U[f'{U_indices[j]}'].append(permutations[i][int(i_pos_U[j])])
